...
-- Classification history (rule changes, re-archiving)
CREATE TABLE classification_history (
    id                        INTEGER PRIMARY KEY AUTOINCREMENT,
    document_id               INTEGER NOT NULL REFERENCES document(id),
    old_path                  TEXT,
    new_path                  TEXT NOT NULL,
    old_rule_id               INTEGER REFERENCES storage_path_rule(id),
    new_rule_id               INTEGER REFERENCES storage_path_rule(id),
    trigger                   TEXT NOT NULL,
    triggering_rule_change_id INTEGER REFERENCES storage_path_rule(id),
    notes                     TEXT,
    created_at                TEXT
);
...
-- Document type catalogue (pre-seeded + AI auto-registration)
...
-- Tag catalogue (pre-seeded + AI auto-registration)
